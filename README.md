...
[mini-agent](https://github.com/miles990/mini-agent) 是一個 24/7 常駐的個人 AI agent，未來將抽取為通用框架 [Asurada](https://github.com/miles990/asurada)（阿斯拉達）— 一個 perception-driven 的個人 AI 夥伴框架，讓任何人都能跑自己的 agent。命名來源：《閃電霹靂車》的 AI 導航系統 — 自主判斷、感知環境、輔助駕駛。
